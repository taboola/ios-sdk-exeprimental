Pod::Spec.new do |s|
  ...
  s.platform            = :ios, '9.0'
  s.source            = { :http => 'https://taboola-mobile-sdk.s3-us-west-2.amazonaws.com/ios/3.5.4/TaboolaSDK.zip' }
  ...
  s.ios.vendored_frameworks = 'TaboolaSDK.framework', 'OMSDK_Taboola.xcframework'
